...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    dists_temp  = np.sqrt(-2*M+tr+np.array(te).reshape(te.shape[0],1))
    print(dists_temp.shape)
    print(type(dists_temp))
...
#       # label.                                                                #
#       #########################################################################
#       label_sorted = np.bincount(closet_y)
#       y_pred[i] = np.argmax(label_sorted)
      #########################################################################
      #                           END OF YOUR CODE                            # 
      #########################################################################
      closest_y = []
